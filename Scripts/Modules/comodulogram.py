...
def function_setCFCcfg(CFCin):
	...
	fXcfg['BPFcfg']['f0'] =  np.linspace(fXcfg['start'],fXcfg['end'],int(np.ceil((fXcfg['end']-fXcfg['start'])/fXcfg['res'])))
	...
	fYcfg['BPFcfg']['f0'] =  np.linspace(fYcfg['start'],fYcfg['end'],int(np.ceil((fYcfg['end']-fYcfg['start'])/fYcfg['res']))) 
